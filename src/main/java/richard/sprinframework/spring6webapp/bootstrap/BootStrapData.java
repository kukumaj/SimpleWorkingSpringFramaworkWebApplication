package richard.sprinframework.spring6webapp.bootstrap;
...
import richard.sprinframework.spring6webapp.repositories.PublisherRepository;
...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Book noEJB = new Book();
        noEJB.setTitle("J2EE Development withoutEJB");
